...
test.describe.parallel('Update Profile', () => {
    ...
    //     await job.updateNaukaryProfile('prajwalnarute2002@gmail.com', 'Prajwal@123', 'Prajwal_Narute.pdf', 'Node.js')
    // });
    ...
    //     const job = new Job(page)
    //     await job.updateNaukaryProfile('prajwalnarute12@gmail.com', 'Prajwal@123', 'Prajwal_Resume.pdf', 'Node.js')
    // });
