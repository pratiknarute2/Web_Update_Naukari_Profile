(async () => {
    const APIs = {
        ...
        au: {
            // Home page, PLP, PDP, Quick top up
            1: 'https://www.lycamobile.com.au/bff/web/pim/v1/get-bundles?type=cvm&draft=false&lang=en',
            2: 'https://www.lycamobile.com.au/bff/web/pim/v1/get-bundles?type=ca&draft=false&lang=en',
            3: 'https://www.lycamobile.com.au/bff/web/cms/v1/template/roaming-bundles?draft=false&lang=en',
            4: 'https://www.lycamobile.com.au/bff/countries/v1/AU/config?draft=false&lang=en',
            5: 'https://www.lycamobile.com.au/bff/web/cms/category/v3/header?draft=false&lang=en',
            6: 'https://www.lycamobile.com.au/bff/countries/v2/AU?draft=false&lang=en',
            7: 'https://www.lycamobile.com.au/bff/web/cms/category/v3/footer?draft=false&lang=en',
            8: 'https://www.lycamobile.com.au/bff/web/pim/v1/get-countries?draft=false&lang=en',
            9: 'https://www.lycamobile.com.au/bff/web/pim/v1/get-all/topup?draft=false&lang=en',
            10: 'https://www.lycamobile.com.au/bff/web/rate/v1/countries/roaming/AU?draft=false&lang=en',
            11: 'https://www.lycamobile.com.au/bff/web/rate/v1/countries/roaming/AU',
            12: 'https://www.lycamobile.com.au/bff/web/rate/v1/countries/roaming',
            13: 'https://www.lycamobile.com.au/bff/web/cms/template/v3/9a724347-6be0-4468-af23-dc24049cdca2?draft=false&lang=en',
            14: 'https://www.lycamobile.com.au/bff/web/cms/template/v3/b3b0b3ac-5905-4950-9795-98adfce36f65?draft=false&lang=en',
            15: 'https://www.lycamobile.com.au/bff/web/cms/template/v3/389eb180-6e3f-428e-ac48-e0c7571fed1d?draft=false&lang=en',
            16: 'https://www.lycamobile.com.au/bff/payment/v1/apm-list/SIM?draft=false&lang=en'
        },
    };

    let countryName = prompt("Enter Country Name (at/au):").toLowerCase();
    if (!APIs[countryName]) {
        console.error("❌ Invalid country! Please enter a valid country.");
        return;
    }

    console.log(`✅ Available APIs for ${countryName}:`);
    Object.entries(APIs[countryName]).forEach(([key, value]) => {
    ...
    let apiNumbers = apiNumbersInput.toLowerCase() === 'all' 
        ? Object.keys(APIs[countryName]) 
        : apiNumbersInput.split(',').map(num => num.trim()).filter(num => APIs[countryName][num]);
    ...
    for (let apiNumber of apiNumbers) {
        let url = APIs[countryName][apiNumber];
